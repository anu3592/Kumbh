    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex flex-col w-[500px] justify-center items-center border-1 rounded-3xl shadow-2xl mt-10 mb-5 p-5">
                ...
                <button className="border-none bg-blue-400 rounded-md text-white m-8 w-[100px] p-2" style={{ backgroundColor: 'skyblue' }} onClick={(e) => goToSite(e)}>Login</button>
                <Link to="/signup"><li className="list-none text-lg text-purple-500 cursor-pointer">(Create account)</li></Link>
            </div>
        </div>
    );
}
